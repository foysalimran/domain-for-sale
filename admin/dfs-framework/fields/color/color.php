 ...
 *
 */
if (!class_exists('DFS_Field_color')) {
  class DFS_Field_color extends DFS_Fields
  {
    ...
    public function render()
    {
      ...
      echo '<input type="text" name="' . esc_attr($this->field_name()) . '" value="' . esc_attr($this->value) . '" class="dfs-color"' . $default_attr . $this->field_attributes() . '/>';
