 ...
 *
 */
if (!class_exists('DFS_Field_textarea')) {
  class DFS_Field_textarea extends DFS_Fields
  {
    ...
    public function shortcoder()
    {
      ...
      if (!empty($this->field['shortcoder'])) {
        ...
        $instances  = (!empty(DFS::$shortcode_instances)) ? DFS::$shortcode_instances : array();
          ...
          foreach ($shortcodes as $shortcode) {
            ...
            foreach ($instances as $instance) {
              ...
              if ($instance['modal_id'] === $shortcode) {
                ...
                echo '<a href="#" class="button button-primary dfs-shortcode-button" data-modal-id="' . esc_attr($id) . '">' . esc_html($title) . '</a>';
              }
            }
          }
        }
