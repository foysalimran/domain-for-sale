 ...
 *
 */
if (!class_exists('DFS_Field_sortable')) {
  class DFS_Field_sortable extends DFS_Fields
  {
    ...
    public function render()
    {
      ...
      echo '<div class="dfs-sortable" data-depend-id="' . esc_attr($this->field['id']) . '">';
      ...
      foreach ($pre_sortby as $key => $field) {
        ...
        echo '<div class="dfs-sortable-item">';

        echo '<div class="dfs-sortable-content">';
        ...
        DFS::field($field, $field_value, $unique_id, 'field/sortable');

        echo '</div>';

        echo '<div class="dfs-sortable-helper"><i class="fas fa-arrows-alt"></i></div>';
