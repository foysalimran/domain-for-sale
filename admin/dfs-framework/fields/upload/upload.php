 ...
 *
 */
if (!class_exists('DFS_Field_upload')) {
  class DFS_Field_upload extends DFS_Fields
  {
    ...
    public function render()
    {
      ...
      if (!empty($args['preview'])) {
        ...
        echo '<div class="dfs--preview' . esc_attr($preview_hidden) . '">';
      ...
      echo '<a href="#" class="button button-primary dfs--button" data-library="' . esc_attr($library) . '">' . $args['button_title'] . '</a>';
      echo '<a href="#" class="button button-secondary dfs-warning-primary dfs--remove' . esc_attr($hidden) . '">' . $args['remove_title'] . '</a>';
      echo '</div>';
