 ...
 *
 */
if (!class_exists('DFS_Field_sorter')) {
  class DFS_Field_sorter extends DFS_Fields
  {
    ...
    public function render()
    {
      ...
      echo '<div class="dfs-sorter" data-depend-id="' . esc_attr($this->field['id']) . '"></div>';

      echo ($args['disabled']) ? '<div class="dfs-modules">' : '';

      echo (!empty($args['enabled_title'])) ? '<div class="dfs-sorter-title">' . esc_attr($args['enabled_title']) . '</div>' : '';
      echo '<ul class="dfs-enabled">';
      ...
      if ($args['disabled']) {
        ...
        echo '<div class="dfs-modules">';
        echo (!empty($args['disabled_title'])) ? '<div class="dfs-sorter-title">' . esc_attr($args['disabled_title']) . '</div>' : '';
        echo '<ul class="dfs-disabled">';
