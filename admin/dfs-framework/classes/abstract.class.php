 ...
 *
 */
if (!class_exists('DFS_Abstract')) {
  abstract class DFS_Abstract
  {
    ...
    public function __construct()
    {
      ...
      if (!empty($this->args['output_css']) || !empty($this->args['enqueue_webfont'])) {
        ...
        DFS::$css = apply_filters("dfs_{$this->unique}_output_css", DFS::$css, $this);
      }
    }
    ...
    public function recursive_output_css($fields = array(), $combine_field = array())
    {
      ...
      if (!empty($fields)) {
        ...
        foreach ($fields as $field) {
          ...
          $field_class  = 'DFS_Field_' . $field_type;
