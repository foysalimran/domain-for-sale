 ...
 *
 */
if (!class_exists('DFS_Fields')) {
  abstract class DFS_Fields extends DFS_Abstract
  {
    ...
    {
      return (!empty($this->field['before'])) ? '<div class="dfs-before-text">' . $this->field['before'] . '</div>' : '';
    }

    public function field_after()
    {

      $output  = (!empty($this->field['after'])) ? '<div class="dfs-after-text">' . $this->field['after'] . '</div>' : '';
      $output .= (!empty($this->field['desc'])) ? '<div class="clear"></div><div class="dfs-desc-text">' . $this->field['desc'] . '</div>' : '';
      $output .= (!empty($this->field['help'])) ? '<div class="dfs-help"><span class="dfs-help-text">' . $this->field['help'] . '</span><i class="fas fa-question-circle"></i></div>' : '';
      $output .= (!empty($this->field['_error'])) ? '<div class="dfs-error-text">' . $this->field['_error'] . '</div>' : '';
