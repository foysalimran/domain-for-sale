...
(function($) {
  ...
  function DOMAIN_FOR_SALEAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  DOMAIN_FOR_SALEAjaxChosen.prototype.init = function() {
  ...
  DOMAIN_FOR_SALEAjaxChosen.prototype.events = function() {
  ...
  DOMAIN_FOR_SALEAjaxChosen.prototype.search_field_focused = function() {
  ...
  DOMAIN_FOR_SALEAjaxChosen.prototype.search_welcome_message = function() {
  ...
  DOMAIN_FOR_SALEAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('domain-for-sale-chosen', _this.options.data).done( function( response ) {
  ...
  DOMAIN_FOR_SALEAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.domain-for-sale-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.DOMAIN_FOR_SALEChosenOrder($hidden_value, true);
  ...
  $.fn.DOMAIN_FOR_SALEAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new DOMAIN_FOR_SALEAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, DOMAIN_FOR_SALEAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  DOMAIN_FOR_SALEAbstractChosenOrder = (function() {

    function DOMAIN_FOR_SALEAbstractChosenOrder() {}

    DOMAIN_FOR_SALEAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    DOMAIN_FOR_SALEAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    DOMAIN_FOR_SALEAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    DOMAIN_FOR_SALEAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    DOMAIN_FOR_SALEAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    DOMAIN_FOR_SALEAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    DOMAIN_FOR_SALEAbstractChosenOrder.DOMAIN_FOR_SALEChosenOrder = function(select, order, force) {
    ...
    return DOMAIN_FOR_SALEAbstractChosenOrder;
  ...
  $.fn.extend({
    DOMAIN_FOR_SALEChosenOrder: function(order, force) {
      return _DOMAIN_FOR_SALEChosenOrder.DOMAIN_FOR_SALEChosenOrder(this, order, force);
    }
  });

  this._DOMAIN_FOR_SALEChosenOrder = (function(_super) {
    __extends(_DOMAIN_FOR_SALEChosenOrder, _super);

    function _DOMAIN_FOR_SALEChosenOrder() {
      _ref = _DOMAIN_FOR_SALEChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _DOMAIN_FOR_SALEChosenOrder.relAttributeName = 'data-option-array-index';

    _DOMAIN_FOR_SALEChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _DOMAIN_FOR_SALEChosenOrder.getDOMElement = function(element) {
    ...
    _DOMAIN_FOR_SALEChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _DOMAIN_FOR_SALEChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _DOMAIN_FOR_SALEChosenOrder;

  })(DOMAIN_FOR_SALEAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('domain-for-sale-depend-on');
        });
        ...
        $(controls).each(function() {
          $(this).addClass('domain-for-sale-depend-on');
        });
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectDOMAIN_FOR_SALE = FormSerializer.serializeObject;
    $.fn.serializeJSONDOMAIN_FOR_SALE   = FormSerializer.serializeJSON;
  }
