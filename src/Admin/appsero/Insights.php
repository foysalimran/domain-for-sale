...
class Insights {
    ...
    public function __construct( $client, $name = null, $file = null ) {
        ...
        if ( is_object( $client ) && is_a( $client, 'DfsAppSero\Client' ) ) {
            $this->client = $client;
        }
    }
    ...
    public function admin_notice() {
        ...
        if ( empty( $this->notice ) ) {
            $notice = sprintf( $this->client->dfs_trans( 'Want to help make <strong>%1$s</strong> even more awesome? Allow %1$s to collect non-sensitive diagnostic data and usage information.' ), $this->client->name );
        } else {
            $notice = $this->notice;
        }
        ...
        $notice .= ' (<a class="' . $this->client->slug . '-insights-data-we-collect" href="#">' . $this->client->dfs_trans( 'what we collect' ) . '</a>)';
        ...
        echo '<div class="updated"><p>';
            ...
            echo '&nbsp;<a href="' . esc_url( $optin_url ) . '" class="button-primary button-large">' . $this->client->dfs_trans( 'Allow' ) . '</a>';
            echo '&nbsp;<a href="' . esc_url( $optout_url ) . '" class="button-secondary button-large">' . $this->client->dfs_trans( 'No thanks' ) . '</a>';
        echo '</p></div>';
    ...
    private function get_uninstall_reasons() {
        $reasons = array(
			...
			array(
				'id'          => 'other',
				'text'        => $this->client->dfs_trans( 'Others' ),
				'placeholder' => $this->client->dfs_trans( 'Could you tell us a bit more?' ),
                'icon'        => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="23" viewBox="0 0 24 6"><g fill="none"><g fill="#177764"><path d="M3 0C4.7 0 6 1.3 6 3 6 4.7 4.7 6 3 6 1.3 6 0 4.7 0 3 0 1.3 1.3 0 3 0ZM12 0C13.7 0 15 1.3 15 3 15 4.7 13.7 6 12 6 10.3 6 9 4.7 9 3 9 1.3 10.3 0 12 0ZM21 0C22.7 0 24 1.3 24 3 24 4.7 22.7 6 21 6 19.3 6 18 4.7 18 3 18 1.3 19.3 0 21 0Z"/></g></g></svg>',
			),
		);
    ...
    <div class="wd-dr-modal-wrap">
        ...
        <div class="wd-dr-modal-body">
            ...
            <p class="wd-dr-modal-reasons-bottom">
                <?php
                       echo sprintf(
	                       $this->client->dfs_trans( 'We share your data with <a href="%1$s" target="_blank">Appsero</a> to troubleshoot problems &amp; make product improvements. <a href="%2$s" target="_blank">Learn more</a> about how Appsero handles your data.'),
