...
( function( blocks, blockEditor, element, components ) {
  ...
  if ( !window.DOMAIN_FOR_SALE_gutenberg_blocks ) { return; }

  Object.values(window.DOMAIN_FOR_SALE_gutenberg_blocks).forEach( function( block ) {
    ...
    registerBlockType(block.name, {
      ...
      edit: function (props) {
        return (
          createElement('div', {className: 'domain-for-sale-shortcode-block'},

            createElement(Button, {
              'data-modal-id': block.modal_id,
              'data-gutenberg-id': block.name,
              className: 'is-secondary domain-for-sale-shortcode-button',
              onClick: function () {
                window.DOMAIN_FOR_SALE_gutenberg_props = props;
              },
            }, block.button_title ),
