...
if ( ! class_exists( 'DOMAIN_FOR_SALE_Abstract' ) ) {
  abstract class DOMAIN_FOR_SALE_Abstract {
    ...
    public function __construct() {
      ...
      if ( ! empty( $this->args['output_css'] ) || ! empty( $this->args['enqueue_webfont'] ) ) {
        ...
        DOMAIN_FOR_SALE::$css = apply_filters( "DOMAIN_FOR_SALE_{$this->unique}_output_css", DOMAIN_FOR_SALE::$css, $this );
      }
    ...
    public function recursive_output_css( $fields = array(), $combine_field = array() ) {
      ...
      if ( ! empty( $fields ) ) {
        ...
        foreach ( $fields as $field ) {
          ...
          $field_class  = 'DOMAIN_FOR_SALE_Field_' . $field_type;
            ...
            if ( class_exists( $field_class ) ) {
              ...
              if ( method_exists( $field_class, 'output' ) || method_exists( $field_class, 'enqueue_google_fonts' ) ) {
                ...
                if ( $field_output && $this->args['output_css'] ) {
                  DOMAIN_FOR_SALE::$css .= $instance->output();
                }
