 ...
 *
 */
if (! class_exists('DOMAIN_FOR_SALE_Field_select_f')) {
	class DOMAIN_FOR_SALE_Field_select_f extends DOMAIN_FOR_SALE_Fields
	{
			...
			if (isset($this->field['options'])) {
				...
				if ((is_array($options) && ! empty($options)) || ! empty($args['chosen'])) {
					...
					if (! empty($args['chosen']) && ! empty($args['multiple'])) {
						...
						echo '<select name="' . esc_attr($field_name) . '" class="domain-for-sale-hidden-select hidden"' . $multiple_attr . $field_attr . '>';
