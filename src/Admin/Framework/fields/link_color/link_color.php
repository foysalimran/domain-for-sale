 ...
 *
 */
if ( ! class_exists( 'DOMAIN_FOR_SALE_Field_link_color' ) ) {
  class DOMAIN_FOR_SALE_Field_link_color extends DOMAIN_FOR_SALE_Fields {
    ...
    public function render() {
      ...
      $color_props = array(
        'color'    => esc_html__( 'Normal', 'domain-for-sale' ),
        'hover'    => esc_html__( 'Hover', 'domain-for-sale' ),
        'active'   => esc_html__( 'Active', 'domain-for-sale' ),
        'visited'  => esc_html__( 'Visited', 'domain-for-sale' ),
        'focus'    => esc_html__( 'Focus', 'domain-for-sale' )
      );
      ...
      foreach ( $color_props as $color_prop_key => $color_prop_value ) {
        ...
        if ( ! empty( $args[$color_prop_key] ) ) {
          ...
          echo '<div class="domain-for-sale--left domain-for-sale-field-color">';
          echo '<div class="domain-for-sale--title">'. esc_attr( $color_prop_value ) .'</div>';
          echo '<input type="text" name="'. esc_attr( $this->field_name( '['. $color_prop_key .']' ) ) .'" value="'. esc_attr( $value[$color_prop_key] ) .'" class="domain-for-sale-color"'. $default_attr . $this->field_attributes() .'/>';
          echo '</div>';
