...
if ( ! class_exists( 'DOMAIN_FOR_SALE_Field_textarea' ) ) {
  class DOMAIN_FOR_SALE_Field_textarea extends DOMAIN_FOR_SALE_Fields {
    ...
    public function shortcoder() {
      ...
      if ( ! empty( $this->field['shortcoder'] ) ) {
        ...
        $instances  = ( ! empty( DOMAIN_FOR_SALE::$shortcode_instances ) ) ? DOMAIN_FOR_SALE::$shortcode_instances : array();
          ...
          foreach ( $shortcodes as $shortcode ) {
            ...
            foreach ( $instances as $instance ) {
              ...
              if ( $instance['modal_id'] === $shortcode ) {
                ...
                echo '<a href="#" class="button button-primary domain-for-sale-shortcode-button" data-modal-id="'. esc_attr( $id ) .'">'. esc_html( $title ) .'</a>';
