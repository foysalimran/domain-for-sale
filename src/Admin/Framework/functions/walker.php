 ...
 *
 */
if ( ! class_exists( 'DOMAIN_FOR_SALE_Walker_Nav_Menu_Edit' ) && class_exists( 'Walker_Nav_Menu_Edit' ) ) {
  class DOMAIN_FOR_SALE_Walker_Nav_Menu_Edit extends Walker_Nav_Menu_Edit {
