...
use ThemeAtelier\DomainForSale\Admin\Views\Metabox\DomainForSaleContentOptions;
...
use ThemeAtelier\DomainForSale\Admin\Views\Metabox\DomainForSaleStyleOptions;
...
class DomainForSaleMetaboxes
{
	...
	public static function option_metabox($prefix)
	{
		...
		DomainForSaleContentOptions::options($prefix);
		DomainForSaleStyleOptions::options($prefix);
